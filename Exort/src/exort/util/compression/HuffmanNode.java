...
public class HuffmanNode implements Comparable<HuffmanNode> {
    ...
    /**
     * Creates a HuffmanNode with "frequency" that leads to "left" and
     * "right".
     */
    ...
    /**
     * Creates a HuffmanNode with "character" and "frequency" that
     * leads to "left" and "right".
     */
    public HuffmanNode(Character character, Integer frequency, HuffmanNode left,
	    HuffmanNode right) {
    ...
    /**
     * Makes this class comparable with other HuffmanNodes. Nodes with lower
     * frequencies are considered less than nodes with higher frequencies.
     */
