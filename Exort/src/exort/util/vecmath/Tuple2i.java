...
public abstract class Tuple2i implements java.io.Serializable, Cloneable {
	...
	/**
	 * Returns true if the Object t1 is of type Tuple2i and all of the data members of t1
	 * are equal to the corresponding data members in this Tuple2i.
	 *
	 * @param t1
	 ...
	 * Tuple2i objects with identical data values (i.e., Tuple2i.equals returns true) will
