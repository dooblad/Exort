...
/**
 * A four-element axis angle represented by double-precision floating point x,y,z,angle
...
public class AxisAngle4d implements java.io.Serializable, Cloneable {
	...
	/**
	 * Constructs and initializes an AxisAngle4d from the components contained in the
	 * array.
	 *
	 * @param a
	...
	/**
	 * Gets the value of this axis angle and places it into the array a of length four in
	 * x,y,z,angle order.
	 *
	 * @param a
	 ...
	 * If the specified matrix has no rotational component, the value of this AxisAngle4d
	 * is set to an angle of 0 about an axis of (0,1,0).
	 *
	 * @param m1
	 *        the matrix4f
	 */
	 ...
	 * quaternion. If the specified quaternion has no rotational component, the value of
	...
	/**
	 * Returns true if the Object o1 is of type AxisAngle4d and all of the data members of
	 * o1 are equal to the corresponding data members in this AxisAngle4d.
	 *
	 * @param o1
	...
	/**
	 * Returns true if the L-infinite distance between this axis-angle and axis-angle a1
	 * is less than or equal to the epsilon parameter, otherwise returns false. The
	 ...
	 * AxisAngle4d objects with identical data values (i.e., AxisAngle4d.equals returns
	 * true) will return the same hash code value. Two objects with different data members
	...
	/**
	 * Get the axis angle, in radians.<br> An axis angle is a rotation angle about the
	 * vector (x,y,z).
	 *
	...
	/**
	 * Set the axis angle, in radians.<br> An axis angle is a rotation angle about the
	 * vector (x,y,z).
	 *
	 * @param angle
