...
/**
 * A 3-element vector that is represented by double-precision floating point x,y,z
 * coordinates. If this value represents a normal, then it should be normalized.
 *
 */
public class Vector3d extends Tuple3d implements java.io.Serializable {
	...
	/**
	 * Returns the angle in radians between this vector and the vector parameter; the
	...
	/**
	 * Adds the incoming vector to this vector.
	 *
	 * @param v1
