...
public class Matrix3f implements java.io.Serializable, Cloneable {
	...
	public float m22;
	/*
	 * double[] tmp = new double[9]; // scratch matrix double[] tmp_rot = new double[9];
	...
	/**
	 * Sets the values in this Matrix3f equal to the row-major array parameter (ie, the
	...
	/**
	 * Returns true if the Object o1 is of type Matrix3f and all of the data members of o1
	 * are equal to the corresponding data members in this Matrix3f.
	 *
	 * @param o1
	 ...
	 * Matrix3f objects with identical data values (i.e., Matrix3f.equals returns true)
