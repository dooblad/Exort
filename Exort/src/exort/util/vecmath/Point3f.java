...
/**
 * A 3 element point that is represented by single precision floating point x,y,z
 * coordinates.
 *
 */
public class Point3f extends Tuple3f implements java.io.Serializable {
	...
	/**
	 * Multiplies each of the x,y,z components of the Point4f parameter by 1/w and places
