...
public class Matrix4d implements java.io.Serializable, Cloneable {
	...
	public double m33;
	/*
	 * double[] tmp = new double[16]; double[] tmp_rot = new double[9]; // scratch matrix
	...
	/**
	 * Constructs and initializes a Matrix4d from the specified 16 element array. this.m00
	...
	/**
	 * Constructs and initializes a Matrix4d from the quaternion, translation, and scale
	...
	/**
	 * Constructs and initializes a Matrix4d from the rotation matrix, translation, and
	...
	/**
	 * Sets the values in this Matrix4d equal to the row-major array parameter (ie, the
	...
	/**
	 * Modifies the translational components of this matrix to the values of the Vector3d
	...
	/**
	 * Returns true if the Object t1 is of type Matrix4d and all of the data members of t1
	 * are equal to the corresponding data members in this Matrix4d.
	 *
	 * @param t1
	 *        the matrix with which the comparison is made
	 * @return true or false
	 ...
	 * Matrix4d objects with identical data values (i.e., Matrix4d.equals returns true)
	 ...
	 * pointOut. The fourth element of the point input parameter is assumed to be one.
	 *
	 * @param point
	...
	/**
	 * Transforms the point parameter with this Matrix4d and places the result back into
	 * point. The fourth element of the point input parameter is assumed to be one.
	 *
	 * @param point
	 *        the input point to be transformed.
	 */
