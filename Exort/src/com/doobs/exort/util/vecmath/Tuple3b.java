...
/**
 * A three byte tuple. Note that Java defines a byte as a signed integer in the range
 * [-128, 127]. However, colors are more typically represented by values in the range [0,
 * 255]. Java 3D recognizes this and, in those cases where Tuple3b is used to represent
...
public abstract class Tuple3b implements java.io.Serializable, Cloneable {
	...
	/**
	 * Places the value of the x,y,z components of this Tuple3b into the array of length
	 * 3.
	 *
	 * @param t
	...
	/**
	 * Sets the value of the x,y,z, data members of this tuple to the values in the array
	 * t of length 3.
	 *
	 * @param t
	...
	/**
	 * Returns true if the Object t1 is of type Tuple3b and all of the data members of t1
	 * are equal to the corresponding data members in this Tuple3b.
	 *
	 * @param t1
	 ...
	 * Tuple3b objects with identical data values (i.e., Tuple3b.equals returns true) will
