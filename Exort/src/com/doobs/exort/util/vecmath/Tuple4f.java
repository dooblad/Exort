...
public abstract class Tuple4f implements java.io.Serializable, Cloneable {
	...
	/**
	 * Returns true if the Object t1 is of type Tuple4f and all of the data members of t1
	 * are equal to the corresponding data members in this Tuple4f.
	 *
	 * @param t1
	 ...
	 * Tuple4f objects with identical data values (i.e., Tuple4f.equals returns true) will
